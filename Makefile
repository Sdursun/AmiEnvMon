...
MAIN_OBJECTS := string_utils.o envmondata.o httpget_responseparse.o settings.o gui.o httpget.o main.o
...
Settings: _main_platform_check $(BUILD_DIR) $(BUILD_DIR)/settings.o $(BUILD_DIR)/settings_gui.o
	$(CC) $(BUILD_DIR)/settings.o $(BUILD_DIR)/settings_gui.o -o Settings $(CFLAGS) $(LDFLAGS)	
